---
layout: post
title: "Software Requirements Analysis —— Limb Motion Recognition and Assistant_v0.3"
date: 2026-05-07 2:00:00
...
- [Part 3 Internal Use Cases](#part-3-internal-use-cases)
  ...
  - [V1 — AI & Motion Recognition](#p3-v1)
    - [1. Actor Table](#1-actor-table-v1)
    - [2. Use Case Table](#2-use-case-table-v1)
    - [3. Detailed Use Cases](#3-detailed-use-cases-v1)
      - [UC-V1-01 Process Session Measurements from V2](#uc-v1-01)
      - [UC-V1-02 Analyse Uploaded Angle Values and Future Sensor Data](#uc-v1-02)
      - [UC-V1-03 Provide Plain-Text Recommendation Results to V2](#uc-v1-03)
- [Part 4 Others](#part-4-others)
  ...
  - [5. V1 — Interface and Data Exchange Summary](#p4-v1-interface)
    - [5.1 IF-V2-V1 - Measurements from V2 to V1](#51-if-v2-v1)
    - [5.2 IF-V1-V2 - Recommendations from V1 to V2](#52-if-v1-v2)
    - [5.3 Generation 1 and Future V1 Input/Output View](#53-gen1-future-io)
    - [5.4 Delivery Rules](#54-delivery-rules)
  - [6. V1 — Functional Requirements Summary](#p4-v1-fr)
  - [7. V1 — Open Questions](#p4-v1-open-questions)
  - [8. V1 — Summary](#p4-v1-summary)
...
| May 6, 2026 | Yiding Wang | Add V2 Backend API & Storage — internal use cases, non-functional requirements, assumptions, and dependencies |
| May 6, 2026 | Yiding Wang | Add external use cases diagram(M1,M2) |
| May 7, 2026 | Yiding Wang | Merge V1 — AI & Motion Recognition: requirement analysis, use cases, functional/non-functional requirements, assumptions, interface specification, and open questions |
...
| 7 | V2 SRS | Sergio Moniz | V2 Backend API & Storage Software Requirements Analysis || 8 | V1 Requirement Analysis | Team V1 | V1 AI & Motion Recognition Software Requirements Analysis v1.4 |
| 9 | V1 SRS | Team V1 | Team V1's SRS. Referred to their requirements regarding integration with V2. |
...
| Actor | Description |
| :--- | :--- |
| V1 | AI & Motion Recognition team — reads measurements from V2, analyses angle values, and produces recommendation results back to V2. |
| V2 | Backend API & Storage — serves as the sole direct communication point for V1 input/output. |
| S2 | Data Processing — indirect upstream source of formatted sensor data; V1 does not communicate directly with S2. |
| M1 | Patient Mobile Application — indirect downstream consumer of V1 results through V2. |
| M2 | Doctor & Admin Module — indirect downstream consumer of V1 results through V2. |
...
| Exact names of the two angle values uploaded by the patient | V1 needs stable field names or a mapping rule for Generation 1. |
...
![](https://diogopinhel.github.io/DSD2026_TeamM1/img/Wang/IUCD-small.png)

[Link here](https://diogopinhel.github.io/DSD2026_TeamM1/img/Wang/IUCD.png)

![](https://diogopinhel.github.io/DSD2026_TeamM1/img/Wang/E1.png)
