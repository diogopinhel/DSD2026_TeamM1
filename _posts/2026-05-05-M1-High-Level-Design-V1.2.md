...
<div class="m1-table-wrap">
  <table class="m1-table">
    ...
    <tbody>
      ...
      <tr><td><span class="badge badge-orange">S2</span> Data Acquisition</td><td>Provides formatted sensor data; receives exercise lifecycle control</td><td><code>IF-M1-S2</code> / <code>IF-S2-M1</code></td><td>Bidirectional</td></tr>
      <tr><td><span class="badge badge-blue">V2</span> Backend API</td><td>Central server — processed AI results, exercise data, rehabilitation schedule, AI evaluations</td><td><code>IF-V2-M1</code> / <code>IF-M1-V2</code></td><td>Bidirectional (REST)</td></tr>
...
<div class="info-block green">
  <strong>📄 Full requirements detail:</strong> <a href="https://diogopinhel.github.io/DSD2026_TeamM1/2026/04/27/M1_SRS_v1_3.html" target="_blank" style="color: var(--cyan);">Software Requirements Specification — M1 v1.3 (Final)</a> — covers all IUC-M1-01-01 through IUC-M1-05-02 with complete use case flows, actors, and constraints.
</div>
  ...
  <table class="m1-table">
    ...
    <tbody>
      <tr>
        ...
        <td><code>IUC-M1-01-01</code> <code>IUC-M1-01-02</code></td>
      </tr>
      <tr>
        ...
        <td><code>IUC-M1-02-01</code></td>
      </tr>
      <tr>
        <td><code>MOD-M1-03</code></td>
        <td><strong>Exercise Controller</strong></td>
        <td>Rehabilitation exercise lifecycle (start / end), S2 exercise control, V2 exercise coordination, measurement data upload</td>
        <td><code>IUC-M1-02-02</code> <code>IUC-M1-02-04</code></td>
      </tr>
      <tr>
        <td><code>MOD-M1-04</code></td>
        <td><strong>RT Feedback</strong></td>
        <td>Real-time joint visualisation, deviation display, alert banners, haptic feedback during active exercise</td>
        <td><code>IUC-M1-02-03</code></td>
      </tr>
      <tr>
        <td><code>MOD-M1-05</code></td>
        <td><strong>Data Sync &amp; Cache Manager</strong></td>
        <td>Exercise history sync with V2, local offline cache, rehabilitation schedule retrieval, AI evaluation display</td>
        <td><code>IUC-M1-03-01</code> <code>IUC-M1-03-02</code> <code>IUC-M1-04-01</code></td>
      </tr>
      <tr>
        <td><code>MOD-M1-06</code></td>
        <td><strong>Notification Manager</strong></td>
        <td>Push token registration with Push Service and V2, incoming notification routing, foreground / background display</td>
        <td><code>IUC-M1-05-01</code> <code>IUC-M1-05-02</code></td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="m1-table-wrap">
  <table class="m1-table">
    ...
    <tbody>
      ...
      <tr><td><code>INT-03</code></td><td>MOD-M1-03</td><td>MOD-M1-04</td><td>ExerciseContext</td><td>Rehabilitation exercise successfully started</td></tr>
      <tr><td><code>INT-04</code></td><td>MOD-M1-02</td><td>MOD-M1-04</td><td>SensorSample[]</td><td>Continuous during active exercise</td></tr>
      <tr><td><code>INT-05</code></td><td>MOD-M1-04</td><td>MOD-M1-03</td><td>MeasurementBatch</td><td>Every ~1s during active exercise</td></tr>
...
<div class="m1-table-wrap">
  <table class="m1-table">
    ...
    <tbody>
      <tr>
        <td>M1 → S2: <em>Start/Close exercise request</em></td>
      ...
      <tr>
        <td>V2 → M1: <em>AI Evaluations / Schedule / History</em></td>
...
<div class="m1-table-wrap">
  <table class="m1-table">
    ...
    <tbody>
      <tr>
        <td><code>IUC-M1-01-01</code></td>
        <td>Register</td>
        <td>MOD-M1-01</td>
        <td><code>IF-M1-V2</code> — sends registration data to V2; receives login token</td>
      </tr>
      <tr>
        <td><code>IUC-M1-01-02</code></td>
        <td>Log In</td>
        <td>MOD-M1-01</td>
        <td><code>IF-M1-V2</code> / <code>IF-V2-M1</code> — forwards credentials to V2; stores returned token</td>
      </tr>
      <tr>
        <td><code>IUC-M1-02-01</code></td>
        <td>Connect Sensor</td>
        <td>MOD-M1-02</td>
        <td><code>IF-S1-M1</code> — BLE scan, connect / disconnect requests to S1</td>
      </tr>
      <tr>
        <td><code>IUC-M1-02-02</code></td>
        <td>Start Rehabilitation Exercise</td>
        <td>MOD-M1-03</td>
        <td><code>IF-M1-V2</code> — creates exercise on V2; <code>IF-M1-S2</code> — instructs S2 to begin data processing</td>
      </tr>
      <tr>
        <td><code>IUC-M1-02-03</code></td>
        <td>Real-Time Motion Feedback</td>
        <td>MOD-M1-04</td>
        <td><code>IF-S2-M1</code> — receives formal sensor data from S2; <code>IF-V2-M1</code> — receives processed AI results from V2</td>
      </tr>
      <tr>
        <td><code>IUC-M1-02-04</code></td>
        <td>End Rehabilitation Exercise</td>
        <td>MOD-M1-03</td>
        <td><code>IF-M1-S2</code> — stops S2 data processing; <code>IF-M1-V2</code> / <code>IF-V2-M1</code> — closes exercise on V2, fetches exercise summary</td>
      </tr>
      <tr>
        <td><code>IUC-M1-03-01</code></td>
        <td>Refresh Historical Records</td>
        <td>MOD-M1-05</td>
        <td><code>IF-M1-V2</code> / <code>IF-V2-M1</code> — fetches recent exercise list from V2, downloads unsynced records</td>
      </tr>
      <tr>
        <td><code>IUC-M1-03-02</code></td>
        <td>View AI Evaluations About Recent Training</td>
        <td>MOD-M1-05</td>
        <td><code>IF-M1-V2</code> / <code>IF-V2-M1</code> — requests AI-generated evaluation reports from V2</td>
      </tr>
      <tr>
        <td><code>IUC-M1-04-01</code></td>
        <td>View Rehabilitation Schedule</td>
        <td>MOD-M1-05</td>
        <td><code>IF-M1-V2</code> / <code>IF-V2-M1</code> — retrieves assigned rehabilitation schedule from V2</td>
      </tr>
      <tr>
        <td><code>IUC-M1-05-01</code></td>
        <td>Register with Push Service</td>
        <td>MOD-M1-06</td>
        <td><code>IF-M1-Push</code> — registers device token with Push Service; <code>IF-M1-V2</code> — forwards registration info to V2</td>
      </tr>
      <tr>
        <td><code>IUC-M1-05-02</code></td>
        <td>Receive Push Notifications</td>
        <td>MOD-M1-06</td>
        <td><code>IF-Push-M1</code> — receives push message from Push Service; displays to patient</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table class="m1-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><strong>Measurement upload path — resolved.</strong> S2 Total System Design v1.0 (May 5, 2026) confirms S2 sends formal sensor data to V2 directly. M1 (MOD-M1-03) uploads measurement batches to V2 separately. Both uploads co-exist; no conflict.</td>
      ...
      <tr>
        ...
        <td><strong>Authentication endpoint</strong> — V2 request handling flow (Total System Design v1.0) confirms <code>/auth</code> route group exists. Exact login endpoint schema pending V2 Interface Specification update.</td>
        <td><span class="badge badge-amber">Open</span></td>
        <td>M1 + V2</td>
      </tr>
      <tr>
        <td><code>OI-05</code></td>
        <td><strong>3D rendering library</strong> — Must be HarmonyOS-compatible (ArkTS). Candidates: ArkUI XComponent + OpenGL ES. Decision pending Sprint 2.</td>
      ...
      <tr>
        ...
        <td><strong>Terminology inconsistency — "exercise" vs "session"</strong> — M1 SRS v1.3 uses "rehabilitation exercise" throughout. The Integration SRS v0.1 (Wang, May 4) still uses "session" in the M1 section. HLD follows SRS v1.3. Integration SRS must be updated for consistency.</td>
        <td><span class="badge badge-amber">Open</span></td>
        <td>M1 + Wang (Integration SRS)</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="m1-table-wrap">
  <table class="m1-table">
    ...
    <tbody>
      <tr><td>1</td><td>M1 SRS — v1.3 (Final)</td><td><code>2026-04-27-M1_SRS_v1_3.md</code></td></tr>
      <tr><td>2</td><td>M1 Interface Specification v1.0</td><td><code>2026-05-05-M1_Interface_Specification.md</code></td></tr>
      <tr><td>3</td><td>S2 Total System Design v1.0</td><td>https://rsdbkhusky.github.io/DSD2026_TeamS2/news/total-system-design.html</td></tr>
      <tr><td>4</td><td>S2 Total Interface Specification v1.0</td><td>https://rsdbkhusky.github.io/DSD2026_TeamS2/news/total-interface-spec.html</td></tr>
      <tr><td>5</td><td>Integration SRS v0.1</td><td><code>2026-05-04-Integration_SRS_othersTeams_v0_1.md</code></td></tr>
