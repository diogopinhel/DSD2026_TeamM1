...
![HarmonyOS Project Structure](https://diogopinhel.github.io/DSD2026_TeamM1/img/Zhang/Harmonyos_w1_1.png)

> 上图展示了 `MyHarmonyApp` 的完整目录结构，涵盖 `AppScope` 全局配置、`entry` 入口模块以及 `src/main/ets/pages` 下的各页面文件，整体结构清晰规范。

**UI 界面预览**

![HarmonyOS Project Structure](https://diogopinhel.github.io/DSD2026_TeamM1/img/Zhang/Harmonyos_w1_2.png)
...
![HarmonyOS App Personal Center Login Page](https://diogopinhel.github.io/DSD2026_TeamM1/img/Zhang/Harmonyos_w1_2.png)
